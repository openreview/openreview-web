...
function TabNavigation({ activeTab, onTabChange }) {
  return (
      <TabList>
        <Tab id="preview-fields" onClick={() => onTabChange('preview-fields')} active={activeTab === 'preview-fields'}>
          Live Preview
        </Tab>
        <Tab id="json-fields" onClick={() => onTabChange('json-fields')} active={activeTab === 'json-fields'}>
          Raw JSON
        </Tab>
      </TabList>
  );
