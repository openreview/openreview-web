...
export async function postOrUpdateOrcidPaper(profileId, accessToken, publication) {
  // check by externalId for existing paper imported by coauthor
  // if not found and is arxiv paper, check by arxiv external id
  // if not found post new paper
  // above should be done when getting existing papers instead of posting
