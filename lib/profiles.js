 ...
 * @param {boolean} options.includeIdentityDocuments // whether to include files uploaded, for profile preview and activation page
 */
export function formatProfileData(profileData, options = {}) {
  ...
  const {
    ...
    includePastStates = false,
    includeIdentityDocuments = false,
  } = options
  ...
  return Object.assign(_.pick(profileData.content, profileFields), {
    ...
    ...(includeIdentityDocuments
      ? { identityDocuments: profileData.content.identityDocuments }
      : {}),
  })
}
