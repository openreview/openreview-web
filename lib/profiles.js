 ...
 * @param {boolean} options.includeDocuments // whether to include files uploaded, for profile preview and
 */
export function formatProfileData(profileData, options = {}) {
  ...
  return Object.assign(_.pick(profileData.content, profileFields), {
    ...
    ...(includeDocuments ? { documents: profileData.content.identityDocuments } : {}),
  })
}
