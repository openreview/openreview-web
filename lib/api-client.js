...
const checkStatus = async (response) => {
  ...
  error.details = Array.isArray(errorBody.errors) ? errorBody.errors[0] : errorBody.errors // TODO:remove this when all errors are using OpenReviewError
  error.path = errorBody.path
  error.fields = errorBody.fields
  error.version = errorBody.version // if version=2 OpenReviewError
