...
/**
 * @typedef {Object} getEdgeBrowserUrlReturnType
 * @property {string} edgeBrowserUrl - the actual url
 * @property {boolean} disabled - whether or not the link should be disabled
 */
/**
 * Takes 3 arrays of invitations (note, tag and edge invitations) and returns an object
 * with formatted invitations grouped by group name
 *
 * @param {string} configNoteId
 * @param {Object} configNoteContent
 * @return {getEdgeBrowserUrlReturnType}
 */
export function getEdgeBrowserUrl(configNoteId, configNoteContent) {
