...
export function getRejectionReasons(currentInstitutionName) {
  ...
  const rejectionReasons = [
    ...
    },
    {
      ...
      rejectionText: `Please ask a supervisor or coauthor or colleague that already has an OpenReview profile to email us from the institutional email in their profile at info@openreview.net to vouch for your registration.\n\n${instructionText}`,
    },
  ]
