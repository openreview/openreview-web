...
export function getRejectionReasons(currentInstitutionName) {
  const instructionText =
    'Please go to login page, enter your email, click on "Didn\'t receive email confirmation?" and follow the activation link to update your information.'
  const rejectionReasons = [
    ...
    },
    {
      ...
      rejectionText: `Please complete your full education and career history in your profile, not just your current position.\n\nA complete history helps us verify your identity and is required for profile activation.\n\n${instructionText}`,
    },
  ]
