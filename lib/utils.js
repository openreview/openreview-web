...
export function getRejectionReasons(currentInstitutionName) {
  const rejectionReasons = [
    ...
    },
    {
      ...
      rejectionText:
        'Please use the following link to upload the requested identity verification documents:\n\n{{documentVerificationLink}}\n\nOnce you have uploaded all of the requested documents, use the activation link in this email to update and submit your profile information.',
    },
    {
      value: 'underageConsentLink',
      label: 'Underage Consent Form Upload Link',
      rejectionText:
        'Please use the following link to upload the completed consent form:\n\n{{underageConsentLink}}\n\nOnce you have uploaded the consent form, use the activation link in this email to update and submit your profile information.',
    },
  ]
