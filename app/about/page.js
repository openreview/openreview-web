      ...
      <div className="row">
        <div className="col-xs-12 col-md-10 col-md-offset-1">
          <p>
            ...
            peer review process, by providing a flexible cloud-based web interface and
            underlying database API enabling the following:
          </p>
          <ul className="list-unstyled">
            <li className="mb-2">
              ...
              different policies, to help scientific communities experiment with open
              scholarship while addressing legitimate concerns regarding confidentiality,
            ...
            <li className="mb-2">
              <strong>Open API:</strong> We provide a simple REST API for accessing and
              uploading records of people, their groupings, document content, invitations and
              reviewing assignments, conflict-of-interest designations, and reviewing workflow
              patterns. You can then write scripts , all with a clear, robust model of
              read/write permissions. Track submissions, monitor review process, send
              customized bulk email messages, automate workflow actions.
            </li>
            <li className="mb-2">
              ...
              a particular purpose. The source code is available on{' '}
              <a
            ...
            <li>
              Many other parts of the OpenReview platform are also open source, and are
              available in the{' '}
              <a
                href="https://github.com/openreview"
                target="_blank"
                rel="noopener noreferrer"
              >
