module.exports = function(forumId, noteId, invitationId, user, isBetaUser) {
  ...
  var onNoteRecsChanged = function(noteRecs) {
    ...
    if (isBetaUser) {
      $('#beta-message').html(
        '<p><span class="glyphicon glyphicon-exclamation-sign pr-1 " aria-hidden="true"></span> OpenReview is testing a new version of this page and needs your feedback. To try the new forum click here: <a href="/forum?id=' + rootRec.note.id + '">View new forum »</a></p>'
      ).show();
    }
