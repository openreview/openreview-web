...
![homepage](/images/faq-homepage-override.png)`,
  ...
  This means that:
  - If submission are double blind, blind copies of submissions will be created (make sure to select Force=True). You can also choose which fields are kept hidden (author names are automatically hidden).
  - If submissions should be public, then they will be released to everyone.
  - If submissions are private, then they will be released to area chairs and reviewers.`,
  }, {
