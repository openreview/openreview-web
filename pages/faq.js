...
`,
  },
  {
    ...
    a: `You can calculate affinity scores and conflicts using the 'Paper Matching Setup' feature from your venue request page. Paper Matching Setup is enabled for any venue with a submission deadline and a selection for the 'Paper Matching' field of the venue request form. This feature allows Program Chairs to compute or upload affinity scores and/or compute conflicts. 

    You can find 'Paper Matching Setup' on your venue request form next to 'Remind Recruitment'. 
    ...
    After you run Paper Matching Setup, a link for ‘Paper Assignments’ should appear on your Program Chair console. From there, you should be able to use the edge browser to automatically make assignments: https://openreview.net/faq#question-edge-browswer
