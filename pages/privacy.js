  ...
  <Layout title="Privacy">
    ...
    <div className="row">
      <div className="col-xs-12 col-md-10 col-md-offset-1">
        ...
        <p>OpenReview ("us", "we", or "our") operates https://openreview.net (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
        ...
        <p>In addition, we may use third party services such as Google Analytics that collect, monitor and analyze this data. The data collected by these sites is solely used internally to improve the site and is never shared.</p>
        ...
        <p>This Privacy Policy is effective as of 03/01/2017 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
